...
const WomenPage = () => {
  return (
    <div>
        ...
        <Link to="/products/womensclothing"><Button className="asosbtnwomen" h="45px" p="25px" rounded="0px" fontWeight="700" _hover={{color : "white", backgroundColor : "black"}}>SHOP AXOX DESIGN</Button></Link>
        </Box>
        ...
        <Flex w="83%" m="auto" mt="60px" p="0px 65px">
          <Flex direction="column" justify="center" w="50%" align="center">
            ...
            <Heading color="black" fontSize="28px" mt="20px" fontWeight="700" letterSpacing="1px">AXOX EDITION</Heading>
          ...
          <Link to="/products/womensclothing"><Button bg="white" fontWeight={700} h="55px" className="catebtn" rounded="0px" _hover={{color : "white", backgroundColor : "black"}}>SHOP AXOX DESIGN</Button></Link>
          </Flex>
        </Flex>
