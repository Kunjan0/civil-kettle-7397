          ...
          <div className={styles.innerlower}>
            <div className={styles.innerLowerone}>
              ...
              <p className={styles.p}>
                ...
                <span className={styles.uSpan}>AXOX DESIGN</span>
              </p>
            ...
            <div className={styles.innerLowertwo}>
              ...
              <div>
                ...
                <p className={styles.p}>
                  This is <span className={styles.uSpan}>AXOX DESIGN</span> –
                  your go-to for all the latest trends, no matter who you are,
                  where you’re from and what you’re up to. Exclusive to AXOX,
            ...
            <div className={styles.innerLowerthree}>
              ...
              <div>
                ...
                <p className={styles.p}>
                  ...
                  AXOX’s investment in Better Cotton’s mission. This product is
